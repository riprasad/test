...
case $BRANCH_NAME in
   ...
   "1.2.x" | "1.3.x")
      ...
      docker push quay.io/riprasad/apicurio-registry-jpa:${BRANCH_NAME}-release
      docker push quay.io/riprasad/apicurio-registry-jpa:${VERSION}
      docker push quay.io/riprasad/apicurio-registry-kafka:${BRANCH_NAME}-release
      docker push quay.io/riprasad/apicurio-registry-kafka:${VERSION}
